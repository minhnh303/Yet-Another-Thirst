...
Scope: current multi-loader rebuild for Minecraft 1.21/1.21.1 (Forge, NeoForge, and Fabric).
...
- [x] NeoForge event adapter
- [x] NeoForge network adapter
- [x] NeoForge client HUD adapter
- [x] Fabric event adapter
- [x] Fabric network adapter
- [x] Fabric client HUD adapter
